...
<body>
   ...
   <section id="seccion-sidebar">
    ...
    <div class="hero-main-container">
        <h2 class="hero-section-title">Destacados</h2>
        
        <div class="hero-carousel-nav-desktop">
        
            <button class="hero-nav-button hero-nav-button-left" aria-label="Anterior" onclick="previousSlide()">
            ...
            <button class="hero-nav-button hero-nav-button-right" aria-label="Siguiente" onclick="nextSlide()">
                <svg width="24" height="60" viewBox="0 0 24 60" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
